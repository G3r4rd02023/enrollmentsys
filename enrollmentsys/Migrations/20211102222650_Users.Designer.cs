...
namespace enrollmentsys.Migrations
{
    ...
    [Migration("20211102222650_Users")]
    partial class Users
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("enrollmentsys.Data.Entities.Manager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("enrollmentsys.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("enrollmentsys.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("enrollmentsys.Data.Entities.Manager", b =>
                {
                    b.HasOne("enrollmentsys.Data.Entities.User", "User")
                        .WithMany("Managers")
                        .HasForeignKey("UserId");
